      ...
      <section className="section">
        <div className="container">
          <div className="text-center mb-16">
            <h1 className="text-h1 text-gray-900 mb-6">Projects</h1>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="grid grid-cols-2 gap-1">
                      {project.features.map((feature, idx) => (
                        <span
                          key={idx}
                          className="text-caption bg-gray-50 text-gray-600 px-2 py-1 rounded border"
                        >
                          {feature}
                        </span>
                      ))}
      ...
      <section className="section bg-subtle">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto">
            <h2 className="text-h2 text-gray-900 mb-4">Interested in collaborating?</h2>
